...
3. Once you've got your new project produced from this template, do a find-and-replace globally within the project with the following substitutions:
    - `matplotplusplus-test` -> your project name in lowercase. You could use `-` to separate words if you like.
    - `MyHovercraftIsFullOfEels` -> your project name in UpperCamelCase. Recommended to capitalise each word.
    - `MATPLOTPLUSPLUS_TEST` -> your project name in UPPER_SNAKE_CASE. Recommended to separate at the words.
    ...
    - `matplotplusplus-test`
    - `matplotplusplus-test/include/matplotplusplus-test`
